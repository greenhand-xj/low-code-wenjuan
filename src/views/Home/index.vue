<template>
  <div class="container">
    ...
    <div class="mb-15">
      <el-button type="primary" :icon="Plus" @click="handleAdd">新增问卷</el-button>
      <el-button type="success" :icon="Compass" @click="handleMaterials">组件市场</el-button>
    </div>
    <el-table :data="tableData" style="width: 100%" borde>
      ...
      <el-table-column fixed="right" label="操作" width="300" align="center" v-slot="row">
